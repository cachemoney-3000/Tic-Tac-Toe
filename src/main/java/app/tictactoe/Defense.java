...
public class Defense {
    ...
    public void defense(Button B_00, Button B_01, Button B_02,
                        Button B_10, Button B_11, Button B_12,
                        Button B_20, Button B_21, Button B_22,
                        int caseNum){
        ...
        if(caseNum == 16 || caseNum == 26 || caseNum == 36){
            ...
            defense_aux(caseNum_subtracted, priority,
                    B_00, B_01, B_02,
                    B_10, B_11, B_12,
                    B_20, B_21, B_22);
        }
    ...
    public void defense_aux(int caseNum, int block,
